...
// Test interoperability: Node encrypts -> pure JS decrypts, pure JS encrypts -> Node decrypts
...
const plaintext = Buffer.from(JSON.stringify({ test: 'Hello 2FA Mimir' }));

// Pure JS encrypt
const ciphertext = aes256Ctr(key, iv, plaintext);

// Node decrypt
const decipher = crypto.createDecipheriv('aes-256-ctr', key, iv);
const nodeDecrypted = Buffer.concat([decipher.update(Buffer.from(ciphertext)), decipher.final()]);

console.log('Node decrypted matches:', nodeDecrypted.equals(plaintext));
console.log('Decrypted text:', nodeDecrypted.toString());
